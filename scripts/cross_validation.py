...
def cross_validation_ls(y, x, k_indices, k):
    ...
    mse_tr, opt_w = imp.least_squares(y_train,x_train)
...
def cross_validation_ls_GD(y, x, k_indices, k, gamma, max_iters, w_initial):
    ...
    mse_tr, opt_w = imp.least_squares_GD(y_train, x_train, w_initial, max_iters,gamma)
    mse_te = imp.compute_mse(y_test, x_test,opt_w)
    return mse_te, opt_w
...
def cross_validation_ls_SGD(y, x, k_indices, k, gamma, max_iters, w_initial, batch_size):
    ...
    mse_tr, opt_w = imp.least_squares_SGD(y_train, x_train, w_initial, batch_size, max_iters, gamma)
    mse_te = imp.compute_mse(y_test, x_test,opt_w)
    return mse_te, opt_w
...
def cross_validation_lr(y, x, k_indices, k, gamma, max_iters, w_initial):
    ...
    loss, opt_w = imp.logistic_regression(y_train, x_train, w_initial, max_iters, gamma)
...
def cross_validation_lrr(y, x, k_indices, k, lambda_, gamma, max_iters, w_initial):
    ...
    loss, opt_w = imp.reg_logistic_regression(y_train,x_train,lambda_,w_initial,max_iters,gamma)
